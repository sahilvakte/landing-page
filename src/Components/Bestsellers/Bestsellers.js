...
const Bestsellers = () => {
  return (
    <div className="bestsellers-main-container">
      <div className="bestseller-width-container">
        <div className="bestseller-sub-container-part">
          {/* Center Tag Data */}
          ...
          <div className="bestsellers-main-container-of-products">
            ...
            <div className="bestseller-product-card-one">
              <div className="bestseller-product-card-one-for-image">
                <img
                  className="bestseller-product-card-one-for-image-product-one-like"
                  alt="like"
                  src={Like}
                />
                <img
                  className="bestseller-product-card-one-for-image-product-one"
                  alt="prod"
                  src={Cardpic}
                />
              </div>
              <div className="bestseller-product-card-one-for-details">
                ...
                <button className="bestseller-product-card-one-for-details-button">
                  Buy Now
                </button>
              </div>
            </div>
            ...
            {/* <div className="bestseller-product-card-two">
              <div className="bestseller-product-card-two-for-image">
                <img
                  className="bestseller-product-card-two-for-image-product-two-like"
                  alt="like"
                  src={Like}
                />
                <img
                  className="bestseller-product-card-two-for-image-product-two"
                  alt="product"
                  src={Cardpic}
                />
              </div>
              <div className="bestseller-product-card-one-for-details">
                ...
                <button className="bestseller-product-card-two-for-details-button">
                  Buy Now
                </button>
              </div>
            </div> */}
