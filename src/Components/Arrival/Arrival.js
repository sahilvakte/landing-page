    ...
    <div className="new-arrival-main-container">
      ...
      <div className="new-arrival-text-data">
        ...
        <p className="new-arrival-tag-line-para">
          The line of Women's sprays Cosmetics in 2019 <br /> was replenished
          with a
          <br /> new masterpiece
        </p>
      </div>
      ...
      {/* Cards */}
      <div className="new-arrival-flex-container">
        <div className="new-arrival-width-container">
          <div className="new-arrival-main-container-of-products">
            ...
            <div className="new-arrival-product-card-one">
              <div className="new-arrival-product-card-one-for-image">
                <img
                  className="new-arrival-product-card-one-for-image-product-one"
              ...
              <div className="new-arrival-product-card-one-for-details">
                <div>
                  <h4 className="new-arrival-product-desc-date">
                    26 January 2022
                  </h4>
                  <h4 className="new-arrival-product-desc-details">
                    Craftos Master Everyday
                    <br />
                    Dinnerware Set
                  </h4>
                </div>
              </div>
              <div className="new-arrival-learn-more-button-div">
              <button className="new-arrival-learn-more-button">
                Learn More
              </button>
              </div>
            </div>
