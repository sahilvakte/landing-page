...
const Review = () => {
  return (
        ...
        <div className="review-container-flex-div">
      <div className="review-container-width-div">
            ...
            <div className="review-section-container-three">
              ...
              <div>
                ...
                <p className="review-para-section">
                  The line of Women's sprays Cosmetics in 2019 was replenished
                  with a new masterpiece - a body spray based on natural oils.
                  In it the floral sound is diluted.
                </p>
              </div>
              ...
              <div className="review-user-information">
                <div>
                  <img className="user-in-review-image" alt="user" src={User} />
                </div>
